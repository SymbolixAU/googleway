...
#' @export
distance_origins <- function(res) .access_result(resultType(res), "dist_origin")

#' @describeIn access_result the destination addresses from a distance query
#' @export
distance_destinations <- function(res) .access_result(resultType(res), "dist_destination")
