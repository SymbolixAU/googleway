...
Googleway provides access to 5 Google Maps APIs through the specified functions
...
To use this package you need a valid **API KEY** for the API you wish to use.
