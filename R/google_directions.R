...
#' polyline prefixed by \code{enc:}. Only available for driving, walking or bicycling modes.
#' List elements must be named either 'stop' or 'via', where 'stop' is used to
#' indicate a stopover for a waypoint, and 'via' will not stop at the waypoint.
