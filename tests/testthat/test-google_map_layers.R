...
test_that("polygons added and removed", {
  ...
  expect_true(
    ...
    '[{"coords":[[{"lat":1,"lng":1},{"lat":2,"lng":2},{"lat":3,"lng":3},{"lat":4,"lng":4}]],"stroke_colour":"#0000FF","stroke_weight":1,"stroke_opacity":0.6,"fill_colour":"#FF0000","fill_opacity":0.35,"id":"1"}]'
  )
