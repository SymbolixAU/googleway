...
google_places <- function(search_string = NULL,
  ...
  ## check radius < 50000m
  if(radius > 50000)
    stop("Radius must be less than or equal to 50,000")
  ...
  if(!is.null(search_string)){
    map_url <- paste0("https://maps.googleapis.com/maps/api/place/textsearch/json?parameters")
  }else{
    map_url <- paste0("https://maps.googleapis.com/maps/api/place/nearbysearch/json?parameters")
  }
