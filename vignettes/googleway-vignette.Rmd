...
You can also display traffic, transit (public transport) or bicycle routes using the functions `add_traffic()`, `add_transit()` and `add_bicycling()` respectively. For example
...
Polylines in Google Maps are formed from a set of latitude/longitude cooridnates, encoded into a polyline string.
