...
```
## taking the polyline generated at the [directions api site](https://developers.google.com/maps/documentation/directions/start#sample-request)

## trip: Disneyland to Universal Studios
